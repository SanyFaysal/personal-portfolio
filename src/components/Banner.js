...
const Banner = () => {
    return (
        <div class="hero min-h-screen   lg:w-[90%] xl:w-[90%] mx-auto ">
            <div class="hero-content flex-col lg:flex-row-reverse mt-0 ">
                <div className='flex w-full justify-center items-center mt-0 '>
                    <img src={clipt} className='max-w-screen-md mx-auto mt-[-60px] ' alt='' />
                </div>
                <div className='w-full text-justify pt-5'>
                    <p className='text-2xl'>Hi , This is</p>
                    <h1 class="text-5xl font-bold text-green-500"> Faysal Ahmed </h1>
                    <p class="py-6 lg:text-4xl text-2xl">I love to visualize ideas and make them live into websites</p>
