...
const ResEmergencyContact = ({ light, setLight }) => {
  return (
    <div className="flex w-full justify-between px-6">
      <div className="dropdown dropdown-bottom mt-[-10px] lg:hidden md:hidden">
        <div className="mt-[-10px]">
          <label tabIndex={0} className="mt-5 block">
            <ExpandCircleDownOutlinedIcon fontSize="large" className="" />
          </label>
        </div>
        <ul
          tabIndex={0}
          className="dropdown-content menu p-2 shadow rounded-0 bg-gray-800 rounded-box "
        >
      ...
      <div className="inline-block lg:hidden md:hidden">
        <label className="swap swap-rotate mx-auto ml-2">
...
export default ResEmergencyContact;
